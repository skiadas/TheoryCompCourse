(*
   ...
   ocamlopt -o test_lang  alphabet.mli alphabet.ml language.mli language.ml
...
test_true (L.contains l2 (Alphabet.explode ("cdddccbab"))) "l2 should contain strings with a";;
test_false (L.contains l2 (Alphabet.explode ("cdddccbb"))) "l2 should not contain strings without a";;
(* l3 is all strings containing at least one b *)
let rec f s = match s with [] -> false | x :: rest -> x = 'b' || f rest
let l3 = L.fromFunction f;;
test_true (L.contains l3 (Alphabet.explode ("cdddccbab"))) "l3 should contain strings with b";;
test_false (L.contains l3 (Alphabet.explode ("cdddccaa"))) "l3 should not contain strings without b";;
(*
...
test_true (L.contains l4 (Alphabet.explode ("cdddccbab"))) "l4 should contain strings with both a and b";;
test_false (L.contains l4 (Alphabet.explode ("cdddccaa"))) "l4 should not contain strings without b";;
test_false (L.contains l4 (Alphabet.explode ("cdddccbb"))) "l4 should not contain strings without a";;
...
test_false (L.contains l5 (Alphabet.explode ("cdddcc"))) "l5 should not contain strings without either a or b";;
test_true (L.contains l5 (Alphabet.explode ("cdddcca"))) "l5 should contain strings with a";;
test_true (L.contains l5 (Alphabet.explode ("cdddbcc"))) "l5 should not contain strings with b";;
...
test_true (L.contains l7 (Alphabet.explode ("aaabb"))) "l7 should contain a's followed by b's";;
test_true (L.contains l7 (Alphabet.explode ("bb"))) "l7 should contain all b's";;
test_true (L.contains l7 (Alphabet.explode ("aaaaa"))) "l7 should contain all a's";;
test_false (L.contains l7 (Alphabet.explode ("bba"))) "l7 should not contain b's before a's";;
test_false (L.contains l7 (Alphabet.explode ("acbb"))) "l7 should contain all other letters";;
